...
```{r}
tidy(prop.test(x = 395, n = 462), conf.int = TRUE, conf.level = 0.95)
```
...
```{r}
tidy(binom.test(x = 395, n = 462), conf.int = TRUE, conf.level = 0.95)
```
...
tidy(pt, conf.int = TRUE, conf.int = 0.95) %>%
...
tidy(bt, conf.int = TRUE, conf.int = 0.95) %>%
  knitr::kable(digits = 3)
```
