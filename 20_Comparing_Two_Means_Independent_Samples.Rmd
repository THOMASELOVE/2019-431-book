...
To address question 9, we'll need to look at the data in each sample. We'll repeat the boxplot and Normal Q-Q plots from Chapter \@ref(Sepsis_RCT), that allow us to assess the Normality of the distributions of (separately) the `temp_drop` results in the Ibuprofen and Placebo groups.
