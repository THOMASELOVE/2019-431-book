...
We'll focus, for a while, on three studies, and the next few Chapters in these Notes summarize each of them, graphically and numerically, and then use them to demonstrate various approaches to making inferences.
...
specialty <- read_csv("data/specialty.csv")
