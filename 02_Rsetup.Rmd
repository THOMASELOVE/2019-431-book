...
# library(boot); library(pander); library(pwr)

library(grid); library(devtools); library(magrittr);
library(knitr); library(NHANES); 
...
- `patchwork`, which is a framework for composing `ggplot2` objects. 
