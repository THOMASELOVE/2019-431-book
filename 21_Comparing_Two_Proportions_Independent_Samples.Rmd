# Comparing Rates/Proportions with Two Independent Samples {#CI-Indep-Sample-Props}
...
The question of interest is whether the percentage of subjects whose temperature dropped is different (and probably larger) in the subjects who received Ibuprofesn than in those who received the Placebo. 
...
So our "crude" estimate of the **odds ratio** of a good outcome for amoxicillin subjects as compared to placebo subjects, is 2.484 / 1.141 = 2.18
...
Applying this method to our Ibuprofen and Sepsis Trial data, we would simply add one to each frequency in the main four cells in our 2x2 table.
